...
def build_product_ranking_prompt(
    *,
    ...
    system = (
        f"You filter products in one grid labeled 0..{N-1}.\n"
        "Use only visual cues (and any text shown inside the image).\n"
        "1=acceptable match (correct color), 0=wrong color.\n"
        "Score EVERY index with integers in [0,1]: "
        "Dont be TOO strict. If you find yourself eliminating nearly all options, you are probably overdoing it."
