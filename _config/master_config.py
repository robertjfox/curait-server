...
SHOPPING_MIN_PRICE = float(os.getenv("SHOPPING_MIN_PRICE", "30"))
...
SERPER_MAX_CONCURRENCY = _env_int("SERPER_MAX_CONCURRENCY", 8, 15)
SHOPPING_SEARCH_TIMEOUT = float(os.getenv("SHOPPING_SEARCH_TIMEOUT", "12.0"))
RANKING_BATCH_SIZE = _env_int("RANKING_BATCH_SIZE", 2, 12)
ITEM_PROCESSING_CONCURRENCY = _env_int("ITEM_PROCESSING_CONCURRENCY", 4, 5)
SEARCH_HTTP_MAX_CONNECTIONS = _env_int("SEARCH_HTTP_MAX_CONNECTIONS", 8, 50)
SEARCH_HTTP_MAX_KEEPALIVE_CONNECTIONS = _env_int("SEARCH_HTTP_MAX_KEEPALIVE_CONNECTIONS", 4, 10)
...
IMAGE_GRID_WORKERS = _env_int("IMAGE_GRID_WORKERS", 2, 8)
OUTFIT_GENERATION_CONCURRENCY = _env_int("OUTFIT_GENERATION_CONCURRENCY", 1, 4)
SEARCH_RANK_OUTFIT_CONCURRENCY = _env_int("SEARCH_RANK_OUTFIT_CONCURRENCY", 1, 8)
GEMINI_IMAGE_CONCURRENCY = _env_int("GEMINI_IMAGE_CONCURRENCY", 1, 4)
